...
- [ ] Update [BigQuery Emulator image](https://github.com/DataBiosphere/azul-bigquery-emulator)
  ...
  - [ ] Update all dependencies in [azul-go-zetasqlite](https://github.com/DataBiosphere/azul-go-zetasqlite)'s `_examples/go.mod`
  - [ ] Update all dependencies in [azul-go-zetasqlite](https://github.com/DataBiosphere/azul-go-zetasqlite)'s `cmd/zetasqlite-cli/go.mod`
