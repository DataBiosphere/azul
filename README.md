...
The steps below are examplary for Python 3.12.1. Replace `3.12.1` with the value
...
Set `PYENV_VERSION` to `3.12.1` in `environment.local.py` at the project root.
...
```
(.venv) ~/workspace/hca/azul$ docker run -it -v ${project_root}/:/root/azul python:3.12.1-bullseye bash

root@97804cb60d95:/# pip --version
pip 22.0.4 from /usr/local/lib/python3.12.1/site-packages/pip (python 3.12)
