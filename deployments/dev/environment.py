...
def env() -> Mapping[str, Optional[str]]:
    ...
    return {
        ...
        'AZUL_TDR_DCP2EBI_SOURCE': 'tdr:broad-jade-dev-data:snapshot/hca_dev_20200915___20200915',
        'AZUL_TDR_IT2EBI_SOURCE': 'tdr:broad-jade-dev-data:snapshot/hca_dev_20200915___20200915',
