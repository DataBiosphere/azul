...
anvil_sources = mkdict({}, 11, mkdelta([
    ...
    mksrc('datarepo-97ec5366', 'ANVIL_CMG_UWash_GRU_IRB_20230418_ANV5_202304201940', 563, prefix='2c'),
...
anvil3_sources = mkdict(anvil2_sources, 151, mkdelta([
    ...
    mksrc('datarepo-e3065356', 'ANVIL_ccdg_washu_cvd_eocad_biome_wgs_20221024_ANV5_202304211601', 648, prefix='37'),
    # @formatter:on
]))
...
anvil4_sources = mkdict(anvil3_sources, 200, mkdelta([
    ...
    mksrc('datarepo-40c2f4f4', 'ANVIL_CCDG_Broad_CVD_AF_Marcus_UCSF_WES_20221222_ANV5_202304242040', 599, prefix='9d'),
    ...
    mksrc('datarepo-f5a4a895', 'ANVIL_CCDG_Broad_NP_Epilepsy_AUSAUS_EPI_BA_ID_MDS_GSA_MD_20221117_ANV5_202304271358', 37, prefix='7'),  # noqa E501
...
anvil5_sources = mkdict(anvil4_sources, 262, mkdelta([
    ...
    mksrc('datarepo-18bd3df4', 'ANVIL_CMG_UWASH_HMB_20230418_ANV5_202402070029', 610, prefix='d8'),
    ...
    mksrc('datarepo-701eea84', 'ANVIL_GTEx_V9_hg38_20221128_ANV5_202402070108', 8619, prefix='33b'),
...
anvil6_sources = mkdict(anvil5_sources, 256, mkdelta([
    ...
    mksrc('datarepo-5495da63', 'ANVIL_CCDG_Broad_NP_Epilepsy_LEBABM_GRU_WES_20230110_ANV5_202403031612', 856, prefix='c3'), # noqa E501
    ...
    mksrc('datarepo-9935aa3f', 'ANVIL_CMH_GAFK_IlluminaGSA_20240311_ANV5_202403121355', 13940, prefix='dea'),
    ...
    mksrc('datarepo-418e64c1', 'ANVIL_ccdg_asc_ndd_daly_talkowski_persico_asd_exome_20221027_ANV5_202403040854', 533, prefix='ab'), # noqa E501
