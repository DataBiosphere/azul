...
python metadata_indexer.py --skip-program TEST --skip-project TEST  --storage-access-token 5f1017f0-d7e9-41c9-b9c4-b013b2ea3015  --client-path ../redwood-client/ucsc-storage-client/ --metadata-schema metadata_schema.json --server-host storage.ucsc-cgl.org --skip-uuid-directory redacted > testfile.txt
deactivate
