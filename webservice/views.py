...
@app_bp.route('/repository/files/piecharts')
@cross_origin()
def get_data_pie():
	print "Getting data"
...
@app_bp.route('/repository/files/exportNew')
@cross_origin()
...
@app_bp.route('/repository/files/facets')
@cross_origin()
def get_facets():
...
@app_bp.route('/repository/files/summary')
@cross_origin()
def get_summary():
...
#Takes filters as parameter.
@app_bp.route('/repository/files/order')
@cross_origin()
def get_order2():
...
@app_bp.route('/repository/files/meta')
@cross_origin()
def get_order3():
...
#Get the manifest. You need to pass on the filters
@app_bp.route('/repository/files/exportOld')
@cross_origin()
...
#Get the manifest. You need to pass on the filters
@app_bp.route('/repository/files/export')
@cross_origin()
def get_manifest():
	m_filters = request.args.get('filters')
	m_Size = request.args.get('size', 25, type=int)
