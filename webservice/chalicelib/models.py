...
#
#     def __repr__(self):
#         return "<Billing, Project: {} , Cost: {}, " \
#                "Time Range: {}-{}, Time created: {}".format(
...
#         dict_representation["start_date"] = datetime.strftime(
#             self.start_date, format="%a %b %d %H:%M:%S %Z %Y")
#         dict_representation["end_date"] = datetime.strftime(
#             self.end_date, format="%a %b %d %H:%M:%S %Z %Y")
#         dict_representation["by_analysis"] = self.cost_by_analysis
#         dict_representation["month_of"] = datetime.strftime(
#             self.start_date, format="%B-%Y")
