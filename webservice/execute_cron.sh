...
./dcc-dashboard-service/instructions.sh --access public --repoBaseUrl storage.ucsc-cgl.org --repoCountry US --repoName Redwood-AWS-Oregon --repoOrg UCSC --repoType Redwood --access_token $REDWOOD_ACCESS_TOKEN > log_instructions.txt 2>&1
