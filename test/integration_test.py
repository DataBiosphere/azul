        ...
        for source in self.managed_access_sources_by_catalog[catalog]:
            ...
            bundle_fqids = sorted(
                ...
                if not (
                    ...
                    and cast(TDRAnvilBundleFQID, bundle_fqid).table_name == BundleType.duos.value
                )
            )
