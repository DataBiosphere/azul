...
class DCP1IndexerTestCase(DCP1CannedBundleTestCase, IndexerTestCase):
    ...
    def _assert_hit_counts(self,
        ...
        if num_replicas is None:
            num_replicas = self._num_expected_replicas(num_contribs)
        expected = {
...
class TestDCP1Indexer(DCP1IndexerTestCase):
    ...
    def test_indexing(self):
        ...
        canned_hits = self._load_canned_result(self.old_bundle)
...
class TestDCP1IndexerWithIndexesSetUp(DCP1IndexerTestCase):
    ...
    def test_concurrent_specimen_submissions(self):
        ...
        self._assert_hit_counts(hits,
                                ...
                                num_replicas=self._num_expected_replicas(num_contribs, num_dups=1))
        for hit in hits:
            qualifier, doc_type = self._parse_index_name(hit)
            if doc_type is DocumentType.replica:
                continue
