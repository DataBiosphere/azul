...
curl -XPUT $url/fb_buffer/ -d @test/service/fb_settings.json
curl -XPUT $url/fb_buffer/_mapping/meta?update_all_types  -d @test/service/fb_mapping.json
curl -XPUT $url/fb_buffer/_bulk?pretty --data-binary @test/service/fb_index.jsonl
...
curl -XPUT $url/fb_real/ -d @test/service/fb_settings.json
curl -XPUT $url/fb_real/_mapping/meta?update_all_types  -d @test/service/fb_mapping.json
curl -XPUT $url/fb_real/_bulk?pretty --data-binary @test/service/fb_index.jsonl
...
curl -XPUT $url/analysis_buffer/ -d @test/service/donor_settings.json
curl -XPUT $url/analysis_buffer/_mapping/meta?update_all_types  -d @test/service/donor_mapping.json
curl -XPUT $url/analysis_buffer/_bulk?pretty --data-binary @test/service/donor_index.jsonl
...
curl -XPUT $url/analysis_real/ -d @test/service/donor_settings.json
curl -XPUT $url/analysis_real/_mapping/meta?update_all_types  -d @test/service/donor_mapping.json
curl -XPUT $url/analysis_real/_bulk?pretty --data-binary @test/service/donor_index.jsonl
