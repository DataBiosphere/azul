            ...
            with open(os.path.join(zip_dir, zip_fname, 'data', 'participants.tsv'), 'r') as fh:
                ...
                self.assertEqual({
                    freeze({
                        ...
                        '__bam_0__dos_url': f'drs://{domain}/51c9ad31-5888-47eb-9e0c-02f042373c4e?version=2018-10-10T031035.284782Z',
                        ...
                        '__bam_1__dos_url': f'drs://{domain}/b1c167da-0825-4c63-9cbc-2aada1ab367c?version=2018-10-10T031035.971561Z',
                        ...
                        '__fastq_read1__dos_url': f'drs://{domain}/c005f647-b3fb-45a8-857a-8f5e6a878ccf?version=2018-10-10T023811.612423Z',
                        ...
                        '__fastq_read2__dos_url': f'drs://{domain}/b764ce7d-3938-4451-b68c-678feebc8f2a?version=2018-10-10T023811.851483Z',
                    }),
                    freeze({
                        ...
                        '__fastq_read1__file_content_type': 'application/gzip; dcp-type=data',
                        '__fastq_read1__dos_url': f'drs://{domain}/7b07f99e-4a8a-4ad0-bd4f-db0d7a00c7bb?version=2018-11-02T113344.698028Z',
                        ...
                        '__fastq_read2__file_content_type': 'application/gzip; dcp-type=data',
                        '__fastq_read2__dos_url': f'drs://{domain}/74897eb7-0701-4e4f-9e6b-8b9521b2816b?version=2018-11-02T113344.450442Z',
