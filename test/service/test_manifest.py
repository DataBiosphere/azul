...
class ManifestTest(WebServiceTestCase):
    ...
    def test_manifest_endpoint_start_execution(self, step_function_helper):
        """
        ...
        execution_status = start_manifest_generation(filters=filters)
    ...
    @mock.patch('azul.service.responseobjects.manifest_service.ManifestService.step_function_helper')
    def test_manifest_endpoint_boto_error(self, step_function_helper):
        """
    ...
    @mock.patch('azul.service.responseobjects.manifest_service.ManifestService.step_function_helper')
    def test_manifest_endpoint_execution_error(self, step_function_helper):
        """
    ...
    @mock.patch('azul.service.responseobjects.manifest_service.ManifestService.step_function_helper')
    def test_manifest_endpoint_invalid_token(self, step_function_helper):
        """
