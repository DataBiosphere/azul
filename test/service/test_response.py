...
class TestResponse(WebServiceTestCase):
    ...
    def test_pagination_search_after_search_before(self):
        ...
        # Note that the sort field 'workflow' is an analysis_protocol field and
        ...
        # 'workflow' field. If the last row did have a 'workflow' field with
        # value of None, 'search_after' would be a translated None ('~null')
