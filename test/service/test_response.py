...
class TestIndexResponse(IndexResponseTestCase):
    ...
    def test_contributors_order(self):
        ...
        project = bundle.metadata['project/250aef61-a15b-4d97-b8b4-54bb997c1d7d']
    ...
    def test_access(self):
        ...
        with mock.patch('azul.plugins.repository.dss.Plugin.list_accessible_sources',
                        return_value=[]):
...
class TestSortAndFilterByCellCount(IndexResponseTestCase):
    ...
    def bundles(cls) -> list[BundleFQID]:
        return [
            ...
            # project=627cb0ba, cs-cells=10001, p-cells=None
            # The cell suspension cell count was incremented in this canned bundle
            # to avoid matching the effectiveCellCount from bundle d7b8cbff.
            cls.bundle_fqid(uuid='fa5be5eb-2d64-49f5-8ed8-bd627ac9bc7a',
                            version='2019-02-14T19:24:38.034764Z'),
            # A bundle with cell suspension cell counts
