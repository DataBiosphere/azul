...
def transform_tf(input_json):
    ...
    # The default generated by Chalice is too conservative. Our own
    # providers.tf.json.template.py pins the exact TF version we're using.
    del input_json['terraform']['required_version']
    ...
    del input_json['data']['null_data_source']
