...
class CGMAdapter:
    ...
    def process_project(self, project: Mapping[str, Any]) -> bool:
        ...
        file_name = self.metadata_file_name('project', project_uuid)
        files[file_name] = self.project_json(project)
    ...
    def project_json(self, project: Mapping[str, Any]) -> JSON:
        """
        Return the body of the project_0.json file.
        """
        schema_version = '14.1.0'
        return {
            'describedBy': f'https://schema.humancellatlas.org/type/project/{schema_version}/project',
            'schema_type': 'project',
            ...
            'funders': [],
            'provenance': {
                'document_id': project['project_uuid'],
