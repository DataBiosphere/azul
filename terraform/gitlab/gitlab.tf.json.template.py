                        ...
                        },
                        {
                            ...
                            'content': jl(
                                ...
                                jw(
                                    ...
                                    #
                                    # If we deleted those, too, we would risk failing the requirements check on sandbox
                                    # builds since that check depends on image caching. The dead line below assumes that
                                    # the most recent pipeline was run less than a month ago.
                                ),
                                '[Install]',
                                'WantedBy='
                            )
