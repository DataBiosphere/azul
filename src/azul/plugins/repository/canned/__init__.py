    ...
    def direct_file_url(self,
        ...
        for source_name in self.sources:
            ...
            try:
                ...
                url = furl(source_name)
                # Compose the file URL by transforming the source URL
                assert url.path.segments[2] == 'tree', url
                url.path.segments[2] = 'raw'
                for segment in descriptor.content['file_name'].split('/'):
