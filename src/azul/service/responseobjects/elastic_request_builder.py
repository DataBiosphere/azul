...
class ElasticTransformDump(object):
    ...
    def transform_manifest(self, request_config_file='request_config.json',
                           filters=None, format='tsv'):
        config_folder = os.path.dirname(service_config.__file__)
        ...
        manifest = ManifestResponse(es_search, manifest_config,
                                    request_config['translation'], format)
