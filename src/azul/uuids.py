...
def validate_uuid_prefix(uuid_prefix: str) -> None:
    ...
    Traceback (most recent call last):
    ...
    azul.RequirementError: Remove the trailing `-` from the uuid prefix: 8f538f5-

    >>> validate_uuid_prefix('8f538f-')
    Traceback (most recent call last):
    ...
    azul.RequirementError: Remove the trailing `-` from the uuid prefix: 8f538f-
    ...
    reject(uuid_prefix.endswith('-'),
           f'Remove the trailing `-` from the uuid prefix: {uuid_prefix}')
    try:
